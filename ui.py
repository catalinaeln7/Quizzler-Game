...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(font=SCORE_FONT, bg=THEME_COLOR, fg="white")
        self.display_score()
        ...
        self.true_btn = Button(image=true_img, command=self.response_true)
        self.false_btn = Button(image=false_img, command=self.response_false)
